    ...
    def set_value_commission(self, cr, uid, lines=[], context={}):
        ...
        for l in lines:
            ...
            if not bareme_below:
                ...
                ## TODO: On vérifie si le client ne fait pas partie de la liste des clients autorisés
                ## TODO: On vérifie si le client n'est pas une collectivité

                ## TODO: On vérifie les droits de l'utilisateur
