...
class wizard_export_tarif(osv.osv_memory):
    ...
    def act_getfile(self, cr, uid, ids, context=None):
        ...
        this.name = 'Tarif_' + this.client + '.csv'
        ...
        # Il faut encore les mettre en forme selon le client concerné

        if this.client == 'HILTON HOTEL':
    ...
    _columns = {
            ...
            'client': fields.selection( ( ('HILTON HOTEL', 'HILTON HOTEL'), 
                                          ('SNCF STRASBOURG', 'SNCF STRASBOURG')
