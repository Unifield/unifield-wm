...
#                values = new_act
        ...
        if key == 'action' and key2 == 'client_print_multi' and 'sale.order' in [x[0] for x in models]:
            ...
            for v in values:
                ...
                or v[2]['report_name'] == 'labels' and (context.get('_terp_view_name') in [Picking_Ticket, Picking_Tickets, Pre_Packing_List, Pre_Packing_Lists, Delivery_Orders, Delivery_Order] or context.get('picking_type', False) == 'delivery_order')\
