...
class TestPO0500(UnifieldTest):
    ...
    def shortDescription(self):
        ...
        """
        res = super(TestPO0500, self).shortDescription()
        res = """Create a PO of type 'Purchase List', Category MED/LOG/SRV,
and priority Normal/Emergency/Priority. Add products MED/LOG from scratch.
Fill the analytic distribution. Validate the PO. Confirm the PO. Process the
IN. Check status of all documents"""
        return res
    ...
    def tearDown(self):
        ...
        :return:
        """
        super(TestPO0500, self).tearDown()
    ...
    def create_po(self, o_categ='other', o_priority='normal',
        ...
        # Make many checks
        self.assert_(
            po_brw.order_type == 'purchase_list',
            """The default order type of the PO is not good :: Is %s,
should be 'purchase_list'.""" % (po_brw.order_type,),
        )
        self.assert_(
...
be 'assigned'""" % in_state,
    ...
    def test_po_0501_external_normal_other(self):
        """
    ...
    def test_po_0502_external_priority_other(self):
        """
        PO with these parameters:
          * Partner type: External
    ...
    def test_po_0503_external_emergency_other(self):
        """
        PO with these parameters:
          * Partner type: External
    ...
    def test_po_0504_external_normal_log(self):
        """
        PO with these parameters:
          * Partner type: External
          * Order priority: Normale
    ...
    def test_po_0505_external_priority_log(self):
        """
        PO with these parameters:
          * Partner type: External
          * Order priority: Priority
    ...
    def test_po_0506_external_emergency_log(self):
        """
        PO with these parameters:
          * Partner type: External
          * Order priority: Emergency
    ...
    def test_po_0507_external_normal_medical(self):
        """
        PO with these parameters:
          * Partner type: External
          * Order priority: Normale
    ...
    def test_po_0508_external_priority_medical(self):
        """
        PO with these parameters:
          * Partner type: External
          * Order priority: Priority
    ...
    def test_po_0509_external_emergency_medical(self):
        """
        PO with these parameters:
          * Partner type: External
          * Order priority: Emergency
    ...
    def test_po_0510_external_service(self):
        """
        PO with these parameters:
          * Partner type: External
          * Order priority: Emergency
