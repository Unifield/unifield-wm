...
class account_move_line(osv.osv):
    ...
    _columns = {
        ...
        'name': fields.char('Description', size=512, required=True, readonly=True),
        ...
        'ref': fields.function(_get_reference, fnct_inv=_set_fake_reference, fnct_search=_search_reference, string='Reference', method=True, type='char', size=512, store=True, readonly=True),
